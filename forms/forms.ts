import { ColumnType, DBValue, ItemColumn } from '../db/types'

export type FormValue = string | boolean

export function getDbValue(formValue: FormValue, type: ColumnType)
: DBValue {
    switch (type) {
...
export function getDBValues(formValues: FormValue[], columns: ItemColumn[])
: DBValue[] {
...
export function getFormValue(dbValue: DBValue, type: ColumnType)
: FormValue {
    switch (type) {
    case ColumnType.Boolean:
        return !!dbValue
...
export function getFormValues(dbValues: DBValue[], columns: ItemColumn[])
: FormValue[] {
